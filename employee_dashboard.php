...
<header class="navbar-custom">
    ...
    <nav class="nav-links">
        ...
        <a href="submit_dispute.php">
            تقديم نزاع
        </a>

        <a href="view_sessions.php">
            عرض الجلسات
        </a>

        <a href="view_settlements.php">
            الرد على التسوية
        </a>
...
<section class="main-section">
    ...
    <div class="cards-container">
        ...
        <a href="submit_dispute.php" class="card-link">
        ...
        <a href="view_sessions.php" class="card-link">
        ...
        <a href="view_settlements.php" class="card-link">
    ...
    <div class="footer-content">
        ...
        <div>
            ...
            <ul>
                ...
                <li>
                    <a href="view_cases.php">عرض الشكاوى
                    </a>
                </li>
