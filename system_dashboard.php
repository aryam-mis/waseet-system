...
<section class="main-section">
    ...
    <h1>
        ...
        <?= $_SESSION['full_name'] ?? 'مسؤول النظام' ?>
    ...
    <div class="cards-container">
        ...
        <!-- طلبات التسجيل -->
<a href="admin_requests.php" class="card-link">
    <div class="custom-card">
        <div class="icon-circle">
...
<footer class="footer">
    ...
    <div class="footer-content">
        ...
        <div>
            ...
            <p>
                <i class="bi bi-envelope"></i>info@waseet.com
            </p>
